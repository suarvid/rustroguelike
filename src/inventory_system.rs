use specs::prelude::*;
use crate::{CombatStats, Consumable, ProvidesHealing, WantsToDropItem, WantsToUseItem};
...
impl<'a> System<'a> for ItemUseSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (player_entity, mut gamelog, entities, mut wants_use_item, names, consumables, healing, mut combat_stats) = data;
